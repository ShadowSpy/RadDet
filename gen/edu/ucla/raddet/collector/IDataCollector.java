 ...
 * Original file: C:\\Users\\Roman\\eclipse\\RadDet\\src\\edu\\ucla\\raddet\\collector\\IDataCollector.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements edu.ucla.raddet.collector.IDataCollector
{
private static final java.lang.String DESCRIPTOR = "edu.ucla.raddet.collector.IDataCollector";
...
/**
 * Cast an IBinder object into an edu.ucla.raddet.collector.IDataCollector interface,
 * generating a proxy if needed.
 */
public static edu.ucla.raddet.collector.IDataCollector asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof edu.ucla.raddet.collector.IDataCollector))) {
return ((edu.ucla.raddet.collector.IDataCollector)iin);
}
return new edu.ucla.raddet.collector.IDataCollector.Stub.Proxy(obj);
}
...
private static class Proxy implements edu.ucla.raddet.collector.IDataCollector
{
